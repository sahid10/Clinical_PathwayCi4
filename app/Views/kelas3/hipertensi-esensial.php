                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya31 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox2131" name="biaya31" value="0" onchange="hitungTotal6()" checked>
                                            <label for="customCheckbox2131" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox2131" name="biaya31" value="0" onchange="hitungTotal6()">
                                            <label for="customCheckbox2131" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya32 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox2132" name="biaya32" value="0" onchange="hitungTotal6()" checked>
                                            <label for="customCheckbox2132" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox2132" name="biaya32" value="0" onchange="hitungTotal6()">
                                            <label for="customCheckbox2132" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya33 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox2133" name="biaya33" value="0" onchange="hitungTotal6()" checked>
                                            <label for="customCheckbox2133" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox2143" name="biaya33" value="0" onchange="hitungTotal6()">
                                            <label for="customCheckbox2133" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya34 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox2134" name="biaya34" value="0" onchange="hitungTotal6()" checked>
                                            <label for="customCheckbox2134" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox2134" name="biaya34" value="0" onchange="hitungTotal6()">
                                            <label for="customCheckbox2134" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya35 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox2135" name="biaya35" value="0" onchange="hitungTotal6()" checked>
                                            <label for="customCheckbox2135" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox2135" name="biaya35" value="0" onchange="hitungTotal6()">
                                            <label for="customCheckbox2135" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya36 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox2136" name="biaya36" value="0" onchange="hitungTotal6()" checked>
                                            <label for="customCheckbox2136" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox2136" name="biaya36" value="0" onchange="hitungTotal6()">
                                            <label for="customCheckbox2136" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya55 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3131" name="biaya55" value="0" onchange="hitungTotal10()" checked>
                                            <label for="customCheckbox3131" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3131" name="biaya55" value="0" onchange="hitungTotal10()">
                                            <label for="customCheckbox3131" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya56 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3132" name="biaya56" value="0" onchange="hitungTotal10()" checked>
                                            <label for="customCheckbox3132" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3132" name="biaya56" value="0" onchange="hitungTotal10()">
                                            <label for="customCheckbox3132" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya57 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox2183" name="biaya57" value="0" onchange="hitungTotal10()" checked>
                                            <label for="customCheckbox2183" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox2183" name="biaya57" value="0" onchange="hitungTotal10()">
                                            <label for="customCheckbox2183" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya59 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3135" name="biaya5" value="0" onchange="hitungTotal10()" checked>
                                            <label for="customCheckbox23139" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3135" name="biaya59" value="0" onchange="hitungTotal10()">
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya60 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3136" name="biaya60" value="0" onchange="hitungTotal10()" checked>
                                            <label for="customCheckbox3136" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3136" name="biaya60" value="0" onchange="hitungTotal10()">
                                            <label for="customCheckbox3136" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya61 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3141" name="biaya61" value="0" onchange="hitungTotal11()" checked>
                                            <label for="customCheckbox3141" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3141" name="biaya61" value="0" onchange="hitungTotal11()">
                                            <label for="customCheckbox3141" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya62 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3142" name="biaya62" value="0" onchange="hitungTotal11()" checked>
                                            <label for="customCheckbox3142" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3142" name="biaya62" value="0" onchange="hitungTotal11()">
                                            <label for="customCheckbox3142" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya63 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3143" name="biaya63" value="0" onchange="hitungTotal11()" checked>
                                            <label for="customCheckbox3143" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3143" name="biaya63" value="0" onchange="hitungTotal11()">
                                            <label for="customCheckbox3143" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya64 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3144" name="biaya64" value="0" onchange="hitungTotal11()" checked>
                                            <label for="customCheckbox3144" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3144" name="biaya64" value="0" onchange="hitungTotal11()">
                                            <label for="customCheckbox3144" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya65 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3145" name="biaya65" value="0" onchange="hitungTotal11()" checked>
                                            <label for="customCheckbox3145" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3145" name="biaya65" value="0" onchange="hitungTotal11()">
                                            <label for="customCheckbox3145" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya66 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3146" name="biaya66" value="0" onchange="hitungTotal11()" checked>
                                            <label for="customCheckbox3146" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox3146" name="biaya66" value="0" onchange="hitungTotal11()">
                                            <label for="customCheckbox3146" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya79 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox4121" name="biaya79" value="0" onchange="hitungTotal14()" checked>
                                            <label for="customCheckbox4121" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox4121" name="biaya79" value="0" onchange="hitungTotal14()">
                                            <label for="customCheckbox4121" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya80 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox4122" name="biaya80" value="0" onchange="hitungTotal14()" checked>
                                            <label for="customCheckbox4122" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox4122" name="biaya80" value="0" onchange="hitungTotal14()">
                                            <label for="customCheckbox4122" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya81 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox4123" name="biaya81" value="0" onchange="hitungTotal14()" checked>
                                            <label for="customCheckbox4123" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbo4123" name="biaya81" value="0" onchange="hitungTotal14()">
                                            <label for="customCheckbox4123" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya82 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox4124" name="biaya82" value="0" onchange="hitungTotal14()" checked>
                                            <label for="customCheckbox4124" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox4124" name="biaya82" value="0" onchange="hitungTotal14()">
                                            <label for="customCheckbox4124" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya83 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox4125" name="biaya83" value="0" onchange="hitungTotal14()" checked>
                                            <label for="customCheckbox4125" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox4125" name="biaya83" value="0" onchange="hitungTotal14()">
                                            <label for="customCheckbox4125" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya84 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox4126" name="biaya84" value="0" onchange="hitungTotal14()" checked>
                                            <label for="customCheckbox4126" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox4126" name="biaya84" value="0" onchange="hitungTotal14()">
                                            <label for="customCheckbox4126" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>b.  Kode SDKI (D0055) : Gangguan Pola Tidur</td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                            ...
                            <tr>
                                <td>c.  Kode SDKI (D0057) : Intoleransi Aktivitas</td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya241 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox8d31" name="biaya241" value="0" onchange="hitungTotal41()" checked>
                                            <label for="customCheckbox8d31" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox8d31" name="biaya241" value="0" onchange="hitungTotal41()">
                                            <label for="customCheckbox8d31" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya242 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox8d32" name="biaya242" value="0" onchange="hitungTotal41()" checked>
                                            <label for="customCheckbox8d32" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox8d32" name="biaya242" value="0" onchange="hitungTotal41()">
                                            <label for="customCheckbox8d32" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya245 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox8d35" name="biaya245" value="0" onchange="hitungTotal41()" checked>
                                            <label for="customCheckbox8d35" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox8d35" name="biaya245" value="0" onchange="hitungTotal41()">
                                            <label for="customCheckbox8d35" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <?php if ($biaya246 == 1) { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox8d36" name="biaya246" value="0" onchange="hitungTotal41()" checked>
                                            <label for="customCheckbox8d36" class="custom-control-label"></label>
                                        <?php } else { ?>
                                            <input class="form-check-input" type="checkbox" id="customCheckbox8d36" name="biaya246" value="0" onchange="hitungTotal41()">
                                            <label for="customCheckbox8d36" class="custom-control-label"></label>
                                        <?php
                                        } ?>
                                    </div>
