...
<div class="card card-primary">
    ...
    <form action="<?= base_url('insertceklist/save1'); ?>" method="post">
        <!-- /.card-header -->
                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <td>
                                <div class="custom-control custom-checkbox">
                                    <?php if ($biaya307 == 26000) { ?>
                                        <input class="form-check-input" type="checkbox" id="customCheckbox7461" name="biaya307" value="26000" onchange="hitungTotal51()" checked>
                                        <label for="customCheckbox7461" class="custom-control-label"></label>
                                    <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" id="customCheckbox7461" name="biaya307" value="26000" onchange="hitungTotal51()">
                                        <label for="customCheckbox7461" class="custom-control-label"></label>
                                    <?php
                                    } ?>
                                </div>
                            ...
                            <td>
                                <div class="custom-control custom-checkbox">
                                    <?php if ($biaya309 == 26000) { ?>
                                        <input class="form-check-input" type="checkbox" id="customCheckbox7462" name="biaya309" value="26000" onchange="hitungTotal51()" checked>
                                        <label for="customCheckbox7462" class="custom-control-label"></label>
                                    <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" id="customCheckbox7462" name="biaya309" value="26000" onchange="hitungTotal51()">
                                        <label for="customCheckbox7462" class="custom-control-label"></label>
                                    <?php
                                    } ?>
                                </div>
                            ...
                            <td>
                                <div class="custom-control custom-checkbox">
                                    <?php if ($biaya309 == 26000) { ?>
                                        <input class="form-check-input" type="checkbox" id="customCheckbox7463" name="biaya309" value="26000" onchange="hitungTotal51()" checked>
                                        <label for="customCheckbox7463" class="custom-control-label"></label>
                                    <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" id="customCheckbox7463" name="biaya309" value="26000" onchange="hitungTotal51()">
                                        <label for="customCheckbox7463" class="custom-control-label"></label>
                                    <?php
                                    } ?>
                                </div>
                            ...
                            <td>
                                <div class="custom-control custom-checkbox">
                                    <?php if ($biaya310 == 26000) { ?>
                                        <input class="form-check-input" type="checkbox" id="customCheckbox7464" name="biaya310" value="26000" onchange="hitungTotal51()" checked>
                                        <label for="customCheckbox7464" class="custom-control-label"></label>
                                    <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" id="customCheckbox7464" name="biaya310" value="26000" onchange="hitungTotal51()">
                                        <label for="customCheckbox7464" class="custom-control-label"></label>
                                    <?php
                                    } ?>
                                </div>
                            ...
                            <td>
                                <div class="custom-control custom-checkbox">
                                    <?php if ($biaya311 == 26000) { ?>
                                        <input class="form-check-input" type="checkbox" id="customCheckbox7465" name="biaya311" value="26000" onchange="hitungTotal51()" checked>
                                        <label for="customCheckbox7465" class="custom-control-label"></label>
                                    <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" id="customCheckbox7465" name="biaya311" value="26000" onchange="hitungTotal51()">
                                        <label for="customCheckbox7465" class="custom-control-label"></label>
                                    <?php
                                    } ?>
                                </div>
                            ...
                            <td>
                                <div class="custom-control custom-checkbox">
                                    <?php if ($biaya312 == 26000) { ?>
                                        <input class="form-check-input" type="checkbox" id="customCheckbox7466" name="biaya312" value="26000" onchange="hitungTotal51()" checked>
                                        <label for="customCheckbox7466" class="custom-control-label"></label>
                                    <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" id="customCheckbox7466" name="biaya312" value="26000" onchange="hitungTotal51()">
                                        <label for="customCheckbox7466" class="custom-control-label"></label>
                                    <?php
                                    } ?>
                                </div>
...
<script>
    ...
    selectOption2.addEventListener('change', function() {
        ...
        // Update the p element with the calculated value
        var klaiminacbg = document.getElementById('klaiminacbg');
        klaiminacbg.val = formatRupiah(nilai);
