...
$query = "SELECT biaya55,biaya56,biaya57,biaya58,biaya59,biaya60 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya55'] + $row['biaya56'] + $row['biaya57'] + $row['biaya58'] + $row['biaya59'] + $row['biaya60'];
    // print_r($totalBiaya);
} else {
