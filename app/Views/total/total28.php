...
$query = "SELECT biaya163,biaya164,biaya165,biaya166,biaya167,biaya168 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya163'] + $row['biaya164'] + $row['biaya165'] + $row['biaya166'] + $row['biaya167'] + $row['biaya168'];
    // print_r($totalBiaya);
} else {
