...
$query = "SELECT biaya97,biaya98,biaya99,biaya100,biaya101,biaya102 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya97'] + $row['biaya98'] + $row['biaya99'] + $row['biaya100'] + $row['biaya101'] + $row['biaya102'];
    // print_r($totalBiaya);
} else {
