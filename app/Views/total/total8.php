...
$query = "SELECT biaya43,biaya44,biaya45,biaya46,biaya47,biaya48 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya43'] + $row['biaya44'] + $row['biaya45'] + $row['biaya46'] + $row['biaya47'] + $row['biaya48'];
    // print_r($totalBiaya);
} else {
