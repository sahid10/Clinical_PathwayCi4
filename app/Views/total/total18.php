...
$query = "SELECT biaya103,biaya104,biaya105,biaya106,biaya107,biaya108 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya103'] + $row['biaya104'] + $row['biaya105'] + $row['biaya106'] + $row['biaya107'] + $row['biaya108'];
    // print_r($totalBiaya);
} else {
