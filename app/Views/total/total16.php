...
$query = "SELECT biaya91,biaya92,biaya93,biaya94,biaya95,biaya96 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya91'] + $row['biaya92'] + $row['biaya93'] + $row['biaya94'] + $row['biaya95'] + $row['biaya96'];
    // print_r($totalBiaya);
} else {
