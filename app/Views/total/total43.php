...
$query = "SELECT biaya253,biaya254,biaya255,biaya256,biaya257,biaya258 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya253'] + $row['biaya254'] + $row['biaya255'] + $row['biaya256'] + $row['biaya257'] + $row['biaya258'];
    // print_r($totalBiaya);
} else {
