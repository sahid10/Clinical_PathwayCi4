...
$query = "SELECT biaya1,biaya2,biaya3,biaya4,biaya5,biaya6 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya1'] + $row['biaya2'] + $row['biaya3'] + $row['biaya4'] + $row['biaya5'] + $row['biaya6'];
    // print_r($totalBiaya);
} else {
