...
$query = "SELECT biaya283,biaya284,biaya285,biaya286,biaya287,biaya288 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya283'] + $row['biaya284'] + $row['biaya285'] + $row['biaya286'] + $row['biaya287'] + $row['biaya288'];
    // print_r($totalBiaya);
} else {
