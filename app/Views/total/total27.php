...
$query = "SELECT biaya157,biaya158,biaya159,biaya160,biaya161,biaya162 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya157'] + $row['biaya158'] + $row['biaya159'] + $row['biaya160'] + $row['biaya161'] + $row['biaya162'];
    // print_r($totalBiaya);
} else {
