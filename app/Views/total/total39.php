...
$query = "SELECT biaya229,biaya230,biaya231,biaya232,biaya233,biaya234 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya229'] + $row['biaya230'] + $row['biaya231'] + $row['biaya232'] + $row['biaya233'] + $row['biaya234'];
    // print_r($totalBiaya);
} else {
