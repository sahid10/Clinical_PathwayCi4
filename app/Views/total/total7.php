...
$query = "SELECT biaya37,biaya38,biaya39,biaya40,biaya41,biaya42 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya37'] + $row['biaya38'] + $row['biaya39'] + $row['biaya40'] + $row['biaya41'] + $row['biaya42'];
    // print_r($totalBiaya);
} else {
