...
$query = "SELECT biaya7,biaya8,biaya9,biaya10,biaya11,biaya12 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya7'] + $row['biaya8'] + $row['biaya9'] + $row['biaya10'] + $row['biaya11'] + $row['biaya12'];
    // print_r($totalBiaya);
} else {
