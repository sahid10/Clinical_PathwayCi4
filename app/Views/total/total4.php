...
$query = "SELECT biaya19,biaya20,biaya21,biaya22,biaya23,biaya24 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya19'] + $row['biaya20'] + $row['biaya21'] + $row['biaya22'] + $row['biaya23'] + $row['biaya24'];
    // print_r($totalBiaya);
} else {
