...
$query = "SELECT biaya217,biaya218,biaya219,biaya220,biaya221,biaya222 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya217'] + $row['biaya218'] + $row['biaya219'] + $row['biaya220'] + $row['biaya221'] + $row['biaya222'];
    // print_r($totalBiaya);
} else {
