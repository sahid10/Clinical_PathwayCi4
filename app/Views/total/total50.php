...
$query = "SELECT biaya295,biaya296,biaya297,biaya298,biaya299,biaya300 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya295'] + $row['biaya296'] + $row['biaya297'] + $row['biaya298'] + $row['biaya299'] + $row['biaya300'];
    // print_r($totalBiaya);
} else {
