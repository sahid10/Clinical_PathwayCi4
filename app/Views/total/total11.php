...
$query = "SELECT biaya61,biaya62,biaya63,biaya64,biaya65,biaya66 FROM simrs.t_clinicalpathway WHERE NOMR = $NOMR";
...
if ($result) {
    ...
    $totalBiaya = $row['biaya61'] + $row['biaya62'] + $row['biaya63'] + $row['biaya64'] + $row['biaya65'] + $row['biaya66'];
    // print_r($totalBiaya);
} else {
